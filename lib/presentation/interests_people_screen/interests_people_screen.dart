import '../interests_people_screen/widgets/interests1_item_widget.dart';
...
import 'package:mitul_s_application181/widgets/app_bar/appbar_title.dart';
                    ...
                    child: Obx(
                      () => ListView.separated(
                        ...
                        itemCount: controller.interestsPeopleModelObj.value
                            .interests1ItemList.value.length,
                        itemBuilder: (context, index) {
                          Interests1ItemModel model = controller
                              .interestsPeopleModelObj
                              .value
                              .interests1ItemList
                              .value[index];
                          return Interests1ItemWidget(
                            model,
                          );
                        },
                      ),
